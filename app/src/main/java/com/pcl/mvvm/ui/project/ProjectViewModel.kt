...
//        .bindExtra(BR.listenner, itemOnClickListener)
    ...
    var itemBinding = ItemBinding.of<NewsBean>(BR.newsBean, R.layout.item_project_list)
        .bindExtra(BR.newsListenner, itemOnClickListener)
...
//    }
    ...
    var freshListener = object : OnRefreshLoadMoreListener {
